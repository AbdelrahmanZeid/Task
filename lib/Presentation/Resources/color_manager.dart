...
class ColorManager {
  ...
  static Color boundingBoxColor = const Color(0xffD9D9D9);
  static Color titleColor = const Color(0xff101010);

  static Color subTitleColor = const Color(0xff707070);
  static Color categoryColorOne = const Color(0xffF2F2F2);
